...
import {
  require_nacl_fast
} from "./chunk-7LVFGCS7.js";
import "./chunk-M6LOJI2X.js";
import {
  require_react
} from "./chunk-2AOXMZOM.js";
import {
  __commonJS,
  __toESM,
  require_dist,
...
var BridgeGateway = class {
  ...
  errorsHandler(e2) {
    ...
    if (!this.isClosed) {
      ...
      if (((_b2 = this.eventSource) === null || _b2 === void 0 ? void 0 : _b2.readyState) === EventSource.CONNECTING) {
...
var openDesktopDeeplinkAttempts = 0;
...
function useTonConnectModal() {
  ...
  return {
    ...
    open: () => {
      if (tonConnectUI2) {
        return tonConnectUI2.modal.open();
      }
    },
    close: () => {
      if (tonConnectUI2) {
        tonConnectUI2.modal.close();
      }
    }
  };
}
